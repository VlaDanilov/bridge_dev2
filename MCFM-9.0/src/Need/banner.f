...
c--- warning message, if necessary
     ...
     &                          '                  September 2019  *'
      ...
      write(6,*) '*                                                *'
      write(6,*) '*  Precision phenomenology with MCFM             *'
      write(6,*) '*   J. M. Campbell, T. Neumann                   *'
      write(6,*) '*     arXiv:1909.09117                           *'
      write(6,*) '*   (release publication of MCFM-9.0)            *'
      write(6,*) '*                                                *'
