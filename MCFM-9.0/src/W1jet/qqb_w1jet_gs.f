...
c--- Q Q - different flavours
        msq(1,j,k)=msq(1,j,k)+(Vsum(k)-half*Vsq(k,-j))*(xn-one/xn)
     &  *(msq15_2(0,k)*sub15_2(gq)+msq15_2v(0,k)*sub15_2v)
        msq(2,j,k)=msq(2,j,k)+half*Vsq(j,-k)*(xn-one/xn)
     &  *(msq25_1(j,0)*sub25_1(gq)+msq25_1v(j,0)*sub25_1v)
        msq(3,j,k)=msq(3,j,k)+half*Vsq(k,-j)*(xn-one/xn)
     &  *(msq16_2(0,k)*sub16_2(gq)+msq16_2v(0,k)*sub16_2v)
        msq(4,j,k)=msq(4,j,k)+(Vsum(j)-half*Vsq(j,-k))*(xn-one/xn)
