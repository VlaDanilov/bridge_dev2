...
c===== based upon similar routines for W and Z
     ...
     & msq(-nf:nf,-nf:nf),assemble,Haa(2),getxmsq_gamgam
...
!      gggaga=zip
     ...
     & msq(-nf:nf,-nf:nf),assemble,Haa(2)
      ...
      real(dp):: msqt(-nf:nf,-nf:nf)
      real(dp):: qsum,tlrem,bitrem
      real(dp):: gggaga,msqgggaga,facgg, tauc, getdynamictau
...
! note that, for this process, the power corrections computed here
! are not expected to provide any improvement due to t-channel diagrams
