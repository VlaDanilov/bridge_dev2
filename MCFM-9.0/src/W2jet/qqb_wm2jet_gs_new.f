...
c--- combination of final-initial and final-final for consistency with Gflag
     ...
     &        m65_7g(0,1,-2)+m65_7g(1,1,-2)+m65_7g(2,1,-2))
     &                          -real(nf,dp)*sub65_7v*(
     &        m65_7vg(0,1,-2)+m65_7vg(1,1,-2)+m65_7vg(2,1,-2))
c--- 28/5/09: symmetrized 65 between _1 and _2
         msq( 7,j,k)=msq( 7,j,k)+half*real(nf,dp)*sub65_1(gq)*(
     &        m15_6g(0,1,-2)+m15_6g(1,1,-2)+m15_6g(2,1,-2))
     &                          -half*real(nf,dp)*sub65_1v*(
     &        m65_1vg(0,1,-2)+m65_1vg(1,1,-2)+m65_1vg(2,1,-2))
         msq(18,j,k)=msq(18,j,k)+half*real(nf,dp)*sub65_2(gq)*(
     &        m25_6g(0,1,-2)+m25_6g(1,1,-2)+m25_6g(2,1,-2))
     &                          -half*real(nf,dp)*sub65_2v*(
...
c--- combination of final-initial and final-final for consistency with Gflag
         msq( 5,j,k)=msq( 5,j,k)+real(nf,dp)*sub65_7(gq)*(
     &        m65_7g(0,-2,1)+m65_7g(1,-2,1)+m65_7g(2,-2,1))
     &                          -real(nf,dp)*sub65_7v*(
     &        m65_7vg(0,-2,1)+m65_7vg(1,-2,1)+m65_7vg(2,-2,1))
c--- 28/5/09: symmetrized 65 between _1 and _2
         msq( 7,j,k)=msq( 7,j,k)+half*real(nf,dp)*sub65_1(gq)*(
